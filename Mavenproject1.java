...
public class Mavenproject1 {
    ...
    public static void main(String[] args) {
        ...
        autosOrdenados.forEach(a -> System.out.println(a.getMarca() + " " + a.getModelo() + " - $" + a.getPrecio())
        );
        ...
        autosOrdenadosMarcaPrecio.forEach(a -> System.out.println(a.getMarca() + " " + a.getModelo() + " - $" + a.getPrecio())
        );
        ...
        autosBaratos.forEach(a -> System.out.println(a.getMarca() + " " + a.getModelo() + " - $" + a.getPrecio())
        );
        System.out.println("--------------------------");
        ...
        modelosChevrolet.forEach(a -> System.out.println(a.getMarca() + " " + a.getModelo() + " - $" + a.getPrecio())
        );
        System.out.println("--------------------------");
